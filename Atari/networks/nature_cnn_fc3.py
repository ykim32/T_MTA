...
class NatureCNN_FC3(nn.Module):
    ...
    def __init__(self, num_actions, hsize):
        ...
        #---------------------------------------        
        # Second dense layer.
        self.fc2 = nn.Linear(512, hsize)   # No second dense layer is better for DQN/TDiscount
        nn.init.normal_(self.fc2.weight, mean=0.0, std=std)         
        self.fc2.bias.data.fill_(0.0)   

        self.fc3 = nn.Linear(hsize, hsize)   # No second dense layer is better for DQN/TDiscount
